...
def create_data_generators(patch_dir, patch_size, batch_size=16):
    ...
    train_images = generator(f'{patch_dir}/train_images', color_mode='grayscale')
    train_masks = generator(f'{patch_dir}/train_masks', color_mode='grayscale')
    val_images = generator(f'{patch_dir}/val_images', color_mode='grayscale')
    val_masks = generator(f'{patch_dir}/val_masks', color_mode='grayscale')

    print(f" - Shape of train image batch: {train_images[0][0].shape}")
    print(f" - Shape of train mask batch: {train_masks[0][0].shape}")
    print(f" - Shape of val image batch: {val_images[0][0].shape}")
    print(f" - Shape of val mask batch: {val_masks[0][0].shape}")
